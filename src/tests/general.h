...
#ifndef TESTS_TEST_GENERAL_H_
#define TESTS_TEST_GENERAL_H_
...
TEST_CLASS(PersistantCredentialsTest);

// Tests if PIN retries persist after replugging.
TEST_CLASS(PersistantPinRetriesTest);

}  // namespace fido2_tests

#endif  // TESTS_TEST_GENERAL_H_
